...
fn random_spheres(image_width: u32, samples_per_pixel: usize) -> (HittableList, Camera) {
    ...
    let bvh = Hittable::BvhNode(BvhNode::new(&world.objects, 0, world.objects.len()));
    let mut world = HittableList::new();
    world.add(bvh);
...
fn earth() -> (HittableList, Camera) {
    ...
    //     0.0, 0.0, 0.0,
    // ))));
    let globe = Hittable::Sphere(Sphere::new(Point3::new(0.0, 0.0, 0.0), 2.0, earth_surface));
...
fn final_scene(
    ...
    world.add(Hittable::BvhNode(BvhNode::new(&boxes1, 0, boxes1.len())));
    ...
    for _ in 0..1000 {
        boxes2.push(Hittable::Sphere(Sphere::new(
    ...
    world.add(Hittable::Translate(Translate::new(
        Arc::new(Hittable::RotateY(RotateY::new(
            Arc::new(Hittable::BvhNode(BvhNode::new(&boxes2, 0, boxes2.len()))),
            15.0,
        ))),
